         ...
         <div className="xl:hidden">
          <form>
            ...
            <div className="mt-6">
              ...
              <button
                type="button"
                className="w-full px-6 py-2 bg-blue-500 text-white font-semibold rounded-lg shadow-md hover:bg-blue-600"
            ...
            <div className="mt-8 text-center">
              <button
                type="button"
                className="w-full px-6 py-2 bg-green-500 text-white font-semibold rounded-lg shadow-md hover:bg-green-600"
                onClick={handleSave}
              >
                Save Resume
              </button>
